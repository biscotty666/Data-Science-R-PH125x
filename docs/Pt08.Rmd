...
# 8.13 Quick plots with `qplot` {#qplot}
...
# 8.14 Grids of plots {#grid.arrange}

There are often reasons to graph plots next to each other. The **gridExtra** package and `grid.arrange` permit us to do that:
```{r}
