...
```
  ...
  a. Nothing happens.
  b. <span class="blue">A blank slate plot.</span>
  c. A scatterplot.
  d. A histogram.
...
5. Now we are going to add a layer and the corresponding aesthetic mappings. For the murders data we plotted total murders versus population sizes. Explore the murders data frame to remind yourself what are the names for these two variables and select the correct answer. Hint: Look at ?murders.
  ...
  c. <span class="blue">total and population.</span>
  d. murders and size.
...
a. <span class="blue">We need to map a character to each point through the label argument in aes.</span>
...
d. <span class="blue">Because we want all colors to be blue, we do not need to map colors, just use the color argument in geom_label.</span>
...
b. <span class="blue">Because each label needs a different color we map the colors through the color argument of aes .</span>
c. Use the color argument in ggplot.
