...
# List of R commands in this chapter
...
<span class="hl2">For a quick plot that avoids accessing variables twice, we can use the <span id="with">`with()`</span> function:</span>

```{r}
with(murders, plot(population, total))
```

## 2.15.2 <span id="hist">`hist()`</span>
...
## 2.15.3 <span id="boxplot">`boxplot()`</span>
...
## 2.15.4 <span class="image">`image()`</span>
